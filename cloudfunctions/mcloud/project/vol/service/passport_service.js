...
class PassportService extends BaseProjectService {
	...
	async getMyDetail(userId) {
		...
		let fields = 'USER_SCORE_USED,USER_SCORE_TOTAL,USER_MOBILE,USER_NAME,USER_FORMS,USER_OBJ,USER_STATUS,USER_CHECK_REASON'
